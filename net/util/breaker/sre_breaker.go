...
func (b *sreBreaker) Allow() error {
	...
	log.Debugf("breaker: request: %d, succee: %d, fail: %d", total, success, total-success)
	...
	log.Debugf("breaker: drop ratio(%f) drop(%t)", dr, drop)
	if drop {
		log.Infof("breaker: drop ratio(%f) drop(%t)", dr, drop)
