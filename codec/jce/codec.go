...
func encodeValueWithTag(buf *bytes.Buffer, tag uint8, v *reflect.Value) error {
	...
	case reflect.Uint8:
		return encodeTagInt8Value(buf, tag, int8(v.Uint()))
	case reflect.Int8:
		return encodeTagInt8Value(buf, tag, int8(v.Int()))
	...
	case reflect.Array, reflect.Slice:
		...
		if 0 != v.Len() && reflect.Uint8 == v.Index(0).Type().Kind() {
...
func EncodeTagUint32Value(buf *bytes.Buffer, v uint32, tag uint8) error {
	encodeTagLongValue(buf, tag, int64(v))
	return nil
}
...
func EncodeTagUint16Value(buf *bytes.Buffer, v uint16, tag uint8) error {
	encodeTagLongValue(buf, tag, int64(v))
	return nil
}
...
func EncodeTagUint8Value(buf *bytes.Buffer, v uint8, tag uint8) error {
	encodeTagLongValue(buf, tag, int64(v))
	return nil
}
func EncodeTagInt8Value(buf *bytes.Buffer, v int8, tag uint8) error {
	encodeTagInt8Value(buf, tag, v)
	return nil
}
...
func Encode(buf *bytes.Buffer, v interface{}, tag uint8) error {
	val := reflect.ValueOf(v)
	encodeValueWithTag(buf, tag, &val)
	return nil
}
...
func DecodeTagUint8Value(buf *bytes.Buffer, v *uint8, tag uint8, required bool) error {
	var err error
	*v, err = decodeTagUint8Value(buf, tag, required)
	return err
}
...
func DecodeTagUint16Value(buf *bytes.Buffer, v *uint16, tag uint8, required bool) error {
	var err error
	*v, err = decodeTagUint16Value(buf, tag, required)
	return err
}
func DecodeTagUint32Value(buf *bytes.Buffer, v *uint32, tag uint8, required bool) error {
	var err error
	*v, err = decodeTagUint32Value(buf, tag, required)
	return err
}
...
func Decode(buf *bytes.Buffer, v interface{}, tag uint8, required bool) error {
	rv := reflect.ValueOf(v)
	if rv.Kind() != reflect.Ptr || rv.IsNil() {
		return &InvalidUnmarshalError{reflect.TypeOf(v)}
	}
